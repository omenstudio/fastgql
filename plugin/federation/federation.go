	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/omenstudio/fastgql/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/omenstudio/fastgql/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/omenstudio/fastgql/graphql.Map"},
		},
	}
