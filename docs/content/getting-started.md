...
$ go get github.com/omenstudio/fastgql
```
...
```bash
$ go run github.com/omenstudio/fastgql init
```
...
And run `go run github.com/omenstudio/fastgql generate`.
...
```go
//go:generate go run github.com/omenstudio/fastgql
```
