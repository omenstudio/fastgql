//go:generate go run github.com/vektah/dataloaden AddressLoader int *github.com/omenstudio/fastgql/example/dataloader.Address
//go:generate go run github.com/vektah/dataloaden OrderSliceLoader int []*github.com/omenstudio/fastgql/example/dataloader.Order
//go:generate go run github.com/vektah/dataloaden ItemSliceLoader int []*github.com/omenstudio/fastgql/example/dataloader.Item
